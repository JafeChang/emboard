package info.jafe.emboard.dao.copy;
...
public class UserDao {
	...
	public boolean addUser(String email, String password, String invitationcode){
		int lastId = getLastId();
		if(lastId == Integer.MAX_VALUE){
			System.err.println("%%%% User Library is full. %%%%");
	...
	public int getLastId(){
		...
		query = session.createQuery(hql);
		int lastId = (int) query.uniqueResult();
		session.close();
		return lastId;
	}
}
