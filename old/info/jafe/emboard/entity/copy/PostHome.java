 ...
 * @see info.jafe.emboard.entity.Post
...
public class PostHome {
	...
	public Post findById(int id) {
		...
		try {
			Post instance = (Post) sessionFactory.getCurrentSession().get("info.jafe.emboard.entity.Post", id);
			if (instance == null) {
	...
	public List findByExample(Post instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("info.jafe.emboard.entity.Post")
