			...
			<div class="col-sm-8 blog-main">
				...
				<ul id="pagination" class="pager">
					<li><c:if test="${currentPage > 1 }">
							<a href="allposts?current=1" class="btn"><span
								class="glyphicon glyphicon-step-backward" aria-hidden="true"></span></a>
							</a>
						</c:if></li>
					<li><c:if test="${currentPage ==1 }">
							<a href="allposts?current=1" class="btn disabled"><span
								class="glyphicon glyphicon-step-backward" aria-hidden="true"></span></a>
							</a>
						</c:if></li>
					<li><c:if test="${currentPage > 1 }">
							<a href="allposts?current=${(currentPage-1)}" class="btn"><span
								class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span></a>
						</c:if></li>
					<li><c:if test="${currentPage ==1 }">
							<a href="allposts?current=${(currentPage-1)}"
					...
					<li><c:if test="${currentPage > 3 }">
							<a href="allposts?current=${(currentPage-3)}" class="btn">${currentPage-3}</a>
						</c:if></li>
					<li><c:if test="${currentPage > 2 }">
							<a href="allposts?current=${(currentPage-2)}" class="btn">${currentPage-2}</a>
						</c:if></li>
					<li><c:if test="${currentPage > 1 }">
							<a href="allposts?current=${(currentPage-1)}" class="btn">${currentPage-1}</a>
						</c:if></li>
					...
					<li><c:if test="${lastPage - currentPage > 0 }">
							<a href="allposts?current=${lastPage}" class="btn"><span
								class="glyphicon glyphicon-step-forward" aria-hidden="true"></span></a>
						</c:if></li>
					<li><c:if test="${lastPage - currentPage ==0 }">
							<a href="allposts?current=${lastPage}" class="btn disabled"><span
								class="glyphicon glyphicon-step-forward" aria-hidden="true"></span></a>
						</c:if></li>
				</ul>
				<br />
